...
class DiffuMoME(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(DiffuMoME, self).__init__(**kwargs)
    ...
    def init_weights(self):
        ...
        super(DiffuMoME, self).init_weights()
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        if self.with_img_backbone and img is not None:
            ...
            return None
        if self.with_img_neck:   ### 对backbone输出的特征进行FPN融合  多尺度融合
    ...
    def extract_pts_feat(self, pts, img_feats, img_metas):
        ...
        if self.with_pts_neck:   ### 对点云特征进行FPN融合
            x = self.pts_neck(x)
        return x
    ...
    def voxelize(self, points):
        ...
        for res in points:
            res_voxels, res_coors, res_num_points = self.pts_voxel_layer(res)  ## 进行体素化
