...
custom_hooks = [
    dict(
        type="FreezeWeight",
        finetune_weight=[
            # MoME decoder-side weights: load by the same state_dict keys and keep trainable.
            ...
            "pts_bbox_head.transformer.bev_type_embed",
            "pts_bbox_head.transformer.rv_type_embed",
            "pts_bbox_head.transformer.cam_embed",
            "pts_bbox_head.transformer.decoder",
            # Diffusion additions that do not exist in the original MoME checkpoint.
            "pts_bbox_head.label_enc",
            "pts_bbox_head.query_embedding",
            "pts_bbox_head.decoder_ref_branches",
            "pts_bbox_head.transformer.time_embed",
        ]
    )
]
